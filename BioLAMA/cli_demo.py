...
def main():
    ...
    while True:
        ...
        sentences = preprocessor.preprocess_single_sent(sentence=text)
        # print(sentences)
        all_preds_probs = decoder.decode([sentences], batch_size=args.batch_size, verbose=False) # topk predictions
